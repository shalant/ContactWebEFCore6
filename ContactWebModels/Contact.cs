...
namespace ContactWebModels
{
    public class Contact
    {
        ...
        [Required(ErrorMessage = "The USer ID is required in order to map the contact to a cuser correctly")]
        ...
        public string FriendlyAddress => State is null ? "" : string.IsNullOrWhiteSpace(StreetAddress1) ? $"{City}, {State.Abbreviation}, {Zip}" :
            ...
            : $"{StreetAddress1}, {StreetAddress1}, {City}, {State.Abbreviation}, {Zip}";
    }
}
